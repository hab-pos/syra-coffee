...
var SetupFormComponent = /** @class */ (function () {
    ...
    SetupFormComponent.prototype.ngOnInit = function () {
        ...
        this.commonService.setupEmitter.subscribe(function (res) {
            _this.ivaForm.setValue({ iva: "" });
            _this.expenseForm.setValue({ expense: "" });
            _this.discountForm.setValue({ name: "", amount: "" });
    ...
    SetupFormComponent.prototype.saveIVA = function () {
        ...
        if (this.ivaForm.valid) {
            this.isLoading = true;
            this.apiService.addIVA({ iva_precent: this.ivaForm.controls["iva"].value.replace(',', '.').trim(), created_by: JSON.parse((_a = localStorage.getItem('syra_admin')) !== null && _a !== void 0 ? _a : "")["data"]["_id"] }).subscribe(function (res) {
    ...
    SetupFormComponent.prototype.saveExpense = function () {
        ...
        if (this.expenseForm.valid) {
            this.isLoading = true;
            this.apiService.addExpense({ expense_name: this.expenseForm.controls["expense"].value, created_by: JSON.parse((_a = localStorage.getItem('syra_admin')) !== null && _a !== void 0 ? _a : "")["data"]["_id"] }).subscribe(function (res) {
                _this.commonService.showAlert(res.message);
                _this.isLoading = false;
                if (res.success) {
                    _this.expenseForm.setValue({ expense: "" });
    ...
    SetupFormComponent.prototype.saveDiscount = function () {
        ...
        if (this.discountForm.controls["name"].value == "") {
            ...
            this.apiService.addDiscount({ discount_name: this.discountForm.controls["name"].value, amount: this.discountForm.controls["amount"].value.replace(',', '.').trim(), type: option, created_by: JSON.parse((_a = localStorage.getItem('syra_admin')) !== null && _a !== void 0 ? _a : "")["data"]["_id"] }).subscribe(function (res) {
                _this.commonService.showAlert(res.message);
                _this.isLoading = false;
                if (res.success) {
                    _this.discountForm.setValue({ name: "", amount: "" });
    ...
    __decorate([
        core_1.Input()
    ], SetupFormComponent.prototype, "sidenav");
    __decorate([
        core_1.Input()
    ], SetupFormComponent.prototype, "field");
    __decorate([
        core_1.ViewChild("percentCheck")
    ], SetupFormComponent.prototype, "percentCheck");
    __decorate([
        core_1.ViewChild("EuroCheck")
    ], SetupFormComponent.prototype, "EuroCheck");
    SetupFormComponent = __decorate([
        core_1.Component({

...
module.exports.updateModifiers = function _callee3(req, res, _) {
  var category, result;
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        ...
        case 6:
          ...
          return _context3.abrupt("return", res.api(200, "Modifier Updated", result, true));

        case 10:
          return _context3.abrupt("return", res.api(200, "Modifier Not available", null, false));
...
module.exports.updateOnlineStatus = function _callee4(req, res, _) {
  return regeneratorRuntime.async(function _callee4$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 2:
          return _context4.abrupt("return", res.api(200, "Status updated Successfully", null, false));
...
module.exports.deleteModifiers = function _callee5(req, res, _) {
  var id;

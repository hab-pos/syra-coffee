...
.trim()
  ...
  module.exports.inventory_name = body('inventory_name')
  .exists().withMessage('category name is mandatory')
  .bail()
  .trim()

  module.exports.reference = body('reference')
  .exists().withMessage('color is mandatory')
  .bail()
  .trim()

  module.exports.unit = body('unit')
  ...
  module.exports.category_id = body('category_id')
